...
const Wine = (props) => {
  ...
  const updatePublished = (status) => {
    WineService.update(currentWine.id, { published: status })
      .then(() => {
        setCurrentWine({ ...currentWine, published: status });
        ...
        <div className="edit-form">
          ...
          <form>
            ...
            <div className="form-group">
              ...
              {currentWine.published ? "Open" : "Closed"}
            </div>
          ...
          {currentWine.isOpen ? (
            ...
            <button
              className="btn btn-successs mr-2"
          ...
          <button className="badge badge-warning mr-2" onClick={deleteWine}>
            Delete
          </button>
